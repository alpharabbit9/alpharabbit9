...
<!-- Monochrome stats dashboard (assets/stats.svg). Regenerated daily by
     .github/workflows/stats.yml -> scripts/generate-cards.mjs, which pulls the live
     figures from GitHub's GraphQL API. Self-hosted rather than a third-party stat
     service, so it never renders as a broken image or a rate-limit error.
     Refresh by hand with:  GH_TOKEN=<token> node scripts/generate-cards.mjs -->
<img src="./assets/stats.svg" width="100%" alt="GitHub statistics — all-time contributions, current and longest streak, all-time commits, pull requests, issues, public repositories, and most-used languages. The live figures are in the image description." />
...
<!-- Contribution activity (assets/activity.svg) — daily contributions over the last
     12 months with a 7-day average line. Generated by the same workflow as stats.svg,
     so the profile has no runtime dependency on a third-party stat service. -->
<img src="./assets/activity.svg" width="100%" alt="Contribution activity over the last 12 months — daily contributions with a seven-day average line. The totals are in the image description." />
...
<a href="https://github.com/alpharabbit9"><img src="https://img.shields.io/badge/GITHUB-0D0D0D?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
&nbsp;
<a href="https://linkedin.com/in/alpharabbit9"><img src="https://img.shields.io/badge/LINKEDIN-0D0D0D?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
&nbsp;
<a href="https://alpharabbit9.dev"><img src="https://img.shields.io/badge/PORTFOLIO-0D0D0D?style=for-the-badge&logo=safari&logoColor=white" alt="Portfolio" /></a>
&nbsp;
...
<sub><samp>DESIGNED WITH INTENTION · BUILT WITH GITHUB MARKDOWN</samp></sub>
